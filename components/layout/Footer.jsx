...
function Footer() {
  ...
  return (
    <footer className="flex flex-col w-full">
      <div className="flex xl:flex-row flex-col justify-center items-center p-4 bg-[#3f3e3e] text-[#CCCCCC]">
        ...
        <div className="flex justify-center text-center w-5/12">
          <p>RETORNO EDUCACION ESQUINA CON ALTA QUEBRADORA S/N, COL.RENACIMIENTO, 39715 Acapulco de Juarez, Mexico</p>
        </div>

      </div>

      <div className=" flex xl:flex-row flex-col justify-center items-center xl:h-28 lg:h-28 md:h-28 sm:h-32 h-36 bg-[#292929] text-[#CCCCCC]">
